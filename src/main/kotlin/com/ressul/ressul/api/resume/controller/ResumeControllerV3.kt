...
import com.ressul.ressul.api.resume.service.RedisCacheResumeApiService
...
class ResumeControllerV3(
	private val resumeApiServiceV2: RedisCacheResumeApiService
) {
	@GetMapping("/{id}")
